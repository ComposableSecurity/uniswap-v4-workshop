contract FullRange is BaseHook {
        ...
        returns (uint128 liquidity)
    {
        ...
        if (poolLiquidity == 0) {
            ...
            UniswapV4ERC20(poolInfo.liquidityToken).mint(address(0), MINIMUM_LIQUIDITY);
        }

        UniswapV4ERC20(poolInfo.liquidityToken).mint(params.to, liquidity);
        ...
        returns (BalanceDelta delta)
    {
        ...
        UniswapV4ERC20 erc20 = UniswapV4ERC20(poolInfo.liquidityToken);
    ...
    function beforeInitialize(address, PoolKey calldata key, uint160) 
        external
        override
        onlyPoolManager //@audit protected
        returns (bytes4)
    {
        ...
        address poolToken = address(new UniswapV4ERC20(tokenSymbol, tokenSymbol)); //@audit token representing UniV2 liquidity

        poolInfo = PoolInfo({hasAccruedFees: false, liquidityToken: poolToken});
        ...
        returns (BalanceDelta delta)
    {
        ...
        uint256 liquidityToRemove = FullMath.mulDiv(
            ...
            UniswapV4ERC20(poolInfo.liquidityToken).totalSupply()
        );
