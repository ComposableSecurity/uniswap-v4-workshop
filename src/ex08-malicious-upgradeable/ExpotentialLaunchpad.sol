...
contract ExponentialLaunchpad is BaseHook { //@audit imagine it's upgradeable
...
//    }
    ...
    returns (BalanceDelta delta)
    {
        ...
        erc20.burn(msg.sender, params.liquidity);//@audit upgrade and remove this - easy theft of liquidity
    }
