...
contract AMAMMHOOK is BaseHook, AMAMM {
    ...
    function afterAddLiquidity(
        ...
        address payer = abi.decode(hookData, (address));//@audit PoolOperator decides who is the payer
    ...
    function beforeRemoveLiquidity(
        ...
        // burn LP token
        UniswapV4ERC20(pool.liquidityToken).burn(payer, uint256(-liquidity));//@audit why not burn someone else's liquidity token
